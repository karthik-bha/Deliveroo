...
const Header = () => {
    return (
      <div className='font-[Outfit]' id="Header">
        <div className="md:relative aspect-[1/1] md:aspect-auto h-[70vh] max-h-[600px] rounded-md bg-[url('/header_img.png')] max-w-[1200px] bg-cover bg-no-repeat bg-center mx-auto  my-4">
